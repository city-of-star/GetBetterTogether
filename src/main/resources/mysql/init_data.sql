...
(
    ...
    core_name1  varchar(100) null comment '核心名称1',
    core_unit1  varchar(100) null comment '核心单位1',
    core_name2  varchar(100) null comment '核心名称2',
    core_unit2  varchar(100) null comment '核心单位2',
    father_id    int          null comment '父运动项目ID（顶层为0）',
    sequence      int          null comment '顺序',
...
(
    ...
    core_value1 double   null comment '核心数值1',
    core_value2 double   null comment '核心数值2',
